...
ifeq ($(GLUON_TARGET),ath79-generic)
    ...
    GLUON_tp-link-cpe210-v1_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe210-v2_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe210-v3_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe220-v3_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe510-v1_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe510-v2_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-cpe510-v3_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-wbs210-v2_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
    GLUON_tp-link-wbs510-v1_SITE_PACKAGES += $(DROP_FFGT_PACKAGES)
endif
...
ifeq ($(GLUON_TARGET),ramips-mt7621)
    ...
    GLUON_ubiquiti-edgerouter-x_SITE_PACKAGES += $(EXCLUDE_USB) $(EXCLUDE_USB_NET) $(EXCLUDE_USB_SERIAL) $(EXCLUDE_USB_STORAGE) ffgt-erx-prep
    GLUON_ubiquiti-edgerouter-x-sfp_SITE_PACKAGES += $(EXCLUDE_USB) $(EXCLUDE_USB_NET) $(EXCLUDE_USB_SERIAL) $(EXCLUDE_USB_STORAGE) ffgt-erx-prep
endif
...
ifeq ($(GLUON_TARGET),ramips-mt76x8)
    ...
    GLUON_tp-link-re305_SITE_PACKAGES += $(EXCLUDE_TLS) $(DROP_FFGT_PACKAGES)
endif
